...
// @generated from file sf/substreams/sink/entity/v1/entity.proto (package sf.substreams.sink.entity.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message sf.substreams.sink.entity.v1.EntityChanges
 */
export class EntityChanges extends Message<EntityChanges> {
  /**
   * @generated from field: repeated sf.substreams.sink.entity.v1.EntityChange entity_changes = 5;
   */
  ...
  static readonly typeName = "sf.substreams.sink.entity.v1.EntityChanges";
...
/**
 * @generated from message sf.substreams.sink.entity.v1.EntityChange
 */
export class EntityChange extends Message<EntityChange> {
  ...
  /**
   * @generated from field: sf.substreams.sink.entity.v1.EntityChange.Operation operation = 4;
   */
  operation = EntityChange_Operation.UNSPECIFIED;

  /**
   * @generated from field: repeated sf.substreams.sink.entity.v1.Field fields = 5;
   */
  fields: Field[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sf.substreams.sink.entity.v1.EntityChange";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum sf.substreams.sink.entity.v1.EntityChange.Operation
 */
export enum EntityChange_Operation {
  ...
  /**
   * @generated from enum value: OPERATION_FINAL = 4;
   */
  FINAL = 4,
}
// Retrieve enum metadata with: proto3.getEnumType(EntityChange_Operation)
proto3.util.setEnumType(EntityChange_Operation, "sf.substreams.sink.entity.v1.EntityChange.Operation", [
  { no: 0, name: "OPERATION_UNSPECIFIED" },
  { no: 1, name: "OPERATION_CREATE" },
  { no: 2, name: "OPERATION_UPDATE" },
  { no: 3, name: "OPERATION_DELETE" },
  { no: 4, name: "OPERATION_FINAL" },
]);

/**
 * @generated from message sf.substreams.sink.entity.v1.Value
 */
export class Value extends Message<Value> {
  /**
   * @generated from oneof sf.substreams.sink.entity.v1.Value.typed
   */
  typed: {
    /**
    ...
    /**
     * @generated from field: sf.substreams.sink.entity.v1.Array array = 10;
     */
    value: Array;
    case: "array";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sf.substreams.sink.entity.v1.Value";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message sf.substreams.sink.entity.v1.Array
 */
export class Array extends Message<Array> {
  /**
   * @generated from field: repeated sf.substreams.sink.entity.v1.Value value = 1;
   */
  value: Value[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sf.substreams.sink.entity.v1.Array";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message sf.substreams.sink.entity.v1.Field
 */
export class Field extends Message<Field> {
  ...
  /**
   * @generated from field: optional sf.substreams.sink.entity.v1.Value new_value = 3;
   */
  newValue?: Value;
   ...
   * Deprecated, this is not used within `graph-node`.
   *
   * @generated from field: optional sf.substreams.sink.entity.v1.Value old_value = 5;
   */
  oldValue?: Value;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sf.substreams.sink.entity.v1.Field";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
